...
public class MosaicImagePanel extends JPanel {
	...
	public void paintComponent(Graphics g) { 
	 ...
	 public void paintComponent(Graphics g, int startX, int startY, int x, int y, BufferedImage image, Mosaic frame) {
		 System.out.println("inpaintComponent");
		...
		public void paintComponent(Graphics g, Point[] originalPoints, Point[] MappedPoints, Mosaic frame) {
			Graphics2D g2 = (Graphics2D) g;
			g2.setColor(Color.RED);
			g2.setStroke(new BasicStroke(1));
		...
		public void paintComponent(Graphics g, BufferedImage img, Point[] originalPoints, Mosaic frame, Color color) {
			super.paintComponent(g);
			Graphics2D g2 = (Graphics2D) g;
			g2.setColor(color);
